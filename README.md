...
- **Playbooks** — 16 documents. Cards you can follow at 2am with a red team on
  the box.
- **Tested** — 571 assertions across 20 suites, including fixtures that plant
...
redteam/                  red-team fixtures and the regression suite:
  self-test.sh            runs every suite below (571 assertions, non-root;
                          454 without the Windows suite, which needs pwsh -
